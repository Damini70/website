      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">TechSolutions</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              We are a leading technology company providing innovative solutions 
              for web development, mobile apps, and digital transformation.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@techsolutions.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-400 text-sm">by TechSolutions Team</span>
            </div>
          </div>
        </div>
      </div>
